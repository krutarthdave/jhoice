...
import 'package:home_services/app/models/e_service_model.dart';
...
class BookEServiceView extends GetView<BookEServiceController> {
  ...
  Widget build(BuildContext context) {
    EService eService = controller.booking.value.eService;
    return Scaffold(
        appBar: AppBar(
          title: Text(
            "Book the Service".tr,
                    ...
                    child: Obx(() {
                      return Column(children: [
                        RadioListTile(
                          ...
                          title: Text("Provider comes to your home",
                              style: Get.textTheme.bodyText2),
                        ),
                        RadioListTile(
                          value: "office",
                          ...
                          title: Text("You visit provider office",
                              style: Get.textTheme.bodyText2),
                        )
                      ]);
                    }),
                ...
                ? Container(
                    ...
                    child: Obx(() {
                      return Column(children: [
                        RadioListTile(
                          value: "online",
                          groupValue: controller.booking.value.mode ?? 'online',
                          onChanged: (value) {
                            controller.booking.update((val) {
                              val.mode = 'online';
                            });
                          },
                          title: Text("Service to be provided online",
                              style: Get.textTheme.bodyText2),
                        ),
                        RadioListTile(
                          value: "offline",
                          ...
                          title: Text("Service will be provided offline",
                              style: Get.textTheme.bodyText2),
                        )
                      ]);
                    }),
